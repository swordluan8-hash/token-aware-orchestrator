...
def run_one(
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        return {
            ...
            "test_output_bytes": _safe_int(accounting.get("test_output_bytes")),
            "test_output_raw_bytes": _safe_int(accounting.get("test_output_raw_bytes")),
            "test_output_truncated_bytes": _safe_int(accounting.get("test_output_truncated_bytes")),
